 ...
 * @author kevin
 */
public class ProfitsView extends javax.swing.JFrame {

    /**
     * Creates new form ProfitsStatisticsView
     */
    public ProfitsView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfitsView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfitsView().setVisible(true);
            }
        });
    }
